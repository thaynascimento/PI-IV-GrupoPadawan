...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $lastName = array(
        ...
        'Ruíz', 'Ríos', 'Saavedra', 'Saiz', 'Sala', 'Salazar', 'Salcedo', 'Salcido', 'Saldaña', 'Saldivar', 'Salgado', 'Salinas', 'Salvador',
        ...
        'Zaragoza', 'Zarate', 'Zavala', 'Zayas', 'Zelaya', 'Zepeda', 'Zúñiga', 'de Andare', 'de Jesús', 'Águilar', 'Álvarez', 'Ávalos', 'Ávila'
    );
